...
public class GlobalManager extends LibraryManager {
    ...
    private GlobalManager(GitPlugin plugin) {
        super(plugin);
        this.plugin = plugin;
    ...
    public static synchronized GlobalManager getManager(GitPlugin plugin) {
        if (instance == null) {
    ...
    private void loadFields(GitPlugin plugin) {
        defaultLang = plugin.getConfig().getString("language", "en");
        pluginName = ChatColor.translateAlternateColorCodes('&', plugin.getConfig().getString("plugin_name", "GitPlugin"));
    ...
    private void saveDefaultConfig() {
        ...
        if (!configFile.exists()) {
            ...
            defaultConfig.set("plugin_name", "GitPlugin");
